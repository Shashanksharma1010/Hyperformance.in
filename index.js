...
const servDrop = document.querySelector('#serv-drop');
const servDropMobile = document.querySelector('#serv-drop-mobile');
const servDropdown = document.querySelector('#serv-dropdown');
const target = document.querySelector('.target');
const servMenuDropdown = document.querySelector('.serv-menu-dropdown');
...
theme_switcher.addEventListener('click', (e) => {
    ...
    if (e.target.checked) {
        ...
        root_theme.style.setProperty('--newShade2','#ADD8E6');
...
// Logic for Dropdown Mobile and tablet

function DropdownNav(Element, disabled) {

    Element.classList.toggle('hide');
    Element.classList.toggle('show-flex');
}

    servDrop.addEventListener('mouseover', (e) => {
        DropdownNav(servDropdown, 'NO');
    })

    servDrop.addEventListener('mouseout', (e) => {
        DropdownNav(servDropdown, 'NO');
    })

    servDropMobile.addEventListener('click', (e) => {
        DropdownNav(servMenuDropdown, 'NO');
    })


// Hamburger and dropdown nav links driver code.
